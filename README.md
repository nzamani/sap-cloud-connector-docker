...
1. Build the Docker image
    ...
    - Behind a Proxy
        ...
        ```sh
        docker build --build-arg http_proxy=http://proxy.mycompany.corp:1234 --build-arg https_proxy=http://proxy.mycompany.corp:1234 -t sapcc:2.12.0.1 .
        ```
...
1. Create a container running as a deamon
    ...
    - Use this one if "random" ports on localhost are fine for you
        ...
        ```sh
        docker run -P -h mysapcc --name sapcc -d sapcc:2.12.0.1
        ```
